...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<List<ProfilePostModel>> getCurrentUserPosts() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<ProfilePostModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map(
            (dynamic i) => ProfilePostModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<PostModel> getPostById(postId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'id': postId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
  ...
  @override
  Future<List<String>> getCommentLikes(commentId) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<dynamic> subscribe(onWhom) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'onWhom': onWhom};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      method: 'POST',
  ...
  @override
  Future<dynamic> unSubscribe(fromWhom) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'fromWhom': fromWhom};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      method: 'POST',
  ...
  @override
  Future<dynamic> addLikeToPost(postId) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<dynamic> addLikeToComment(commentId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'commentId': commentId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> removeLikeFromPost(postId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'postId': postId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> removeLikeFromComment(commentId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'commentId': commentId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/Like/RemoveLikeFromComment',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
